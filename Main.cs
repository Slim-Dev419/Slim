...
namespace Golemo
{
    ...
    { 
        public static string Codename { get; } = "Slim";
        ...
        public void ClientEvent_Spawn(Player player, int id)
        {
            ...
            try
            {
                ...
                player.SendChatMessage($"Добро пожаловать на Shadow Roleplay, {name} {surname}!");
        ...
        public static void CMD_BUILD(Player client)
        {
            try
            {
                ...
                //client.SendChatMessage($"Shadow RolePlay - https://discord.gg/edAJjWN !{{#00FFFF}}");
            }
            catch { }
        }
